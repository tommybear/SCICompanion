...
- **Compression Subsystem**: Passthrough, base LZW, LZW_1, DCL, STACpack, and LZW_Pic/View reorder implementations are wired with unit coverage. Fixture consolidation (real-world STACpack payloads) and interactive CLI helpers remain (`docs/Compression_MILESTONES.md`, `Reference_Deprecated_Project/SCICompanionLib`).
...
1. **Stabilize M2**
   ...
   - Finish STACpack fixture coverage with real SCI2 payloads and wire diagnostics into tooling.
