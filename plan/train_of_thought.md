...
- **Phase 3 Tooling**: CLI exports are palette-aware and now include opcode/plane summaries (`--pic-summary`) plus pixel-diff comparisons (`--compare`). Draw-order analytics, automated baselines, and opcode-stream dumps remain.
